...
$(function() {
    ...
    $("#ModelForActivateService [name='endDate']").change(function() {
        if ($(this).val() != "") {
            ...
            var stDateA = $(this).val().split(".");
            var dA = new Date(stDateA[2], stDateA[1] - 1, stDateA[0]);
            var stDateB = $(this).attr("now").split(".");
            var dB = new Date(stDateB[2], stDateB[1] - 1, stDateB[0]);
