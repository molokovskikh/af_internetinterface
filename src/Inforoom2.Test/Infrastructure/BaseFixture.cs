...
namespace Inforoom2.Test.Infrastructure
{
	...
	public class BaseFixture : MySeleniumFixture
	{
		...
		public void CleanDb()
		{
			...
			var order = "publicdataContext,publicdata,connectedhouses,payments,bankpayments,StaticIps,orderservices,orders,planchangerdata,planhtmlcontent,permissiontouser,roletouser,perm_role,user_role,roles,permissions,lawyerperson,plantvchannelgroups,requests,tvchanneltvchannelgroups,tvchannels,"
