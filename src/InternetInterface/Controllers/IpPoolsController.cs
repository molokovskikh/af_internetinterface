...
namespace InternetInterface.Controllers
{
    ...
    public class IpPoolsController : InternetInterfaceController
    {
        ...
        public void ChainIpPoolWithRegion(uint regionId, [ARDataBind("addRegPool", AutoLoad = AutoLoadBehavior.NewInstanceIfInvalidKey)] IpPoolRegion addRegPool)
        {
        ...
        public void UnchainIpPoolWithRegion(uint regionId, [ARDataBind("delRegPool", AutoLoad = AutoLoadBehavior.NewInstanceIfInvalidKey)] IpPoolRegion delRegPool)
        {
