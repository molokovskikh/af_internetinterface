...
jQuery(function($, undefined) {
	...
	var $w = $(window),
		...
		_nmObj = {
			...
			closeButton: '<a href="#" class="nyroModalClose nyroModalCloseButton nmReposition" title="Закрыть"><img alt="Save" src="../Images/delete.png"> Закрыть</a>',	// Close button HTML
