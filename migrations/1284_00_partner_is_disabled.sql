...
alter table Internet.NetworkSwitches add index (Zone), add constraint FK_Internet_NetworkSwitches_Zone foreign key (Zone) references internet.NetworkZones (Id) on delete set null;
