...
CREATE TABLE internet.`inforoom2_user_role` (
	...
	CONSTRAINT `FK98962F172F2E5505` FOREIGN KEY (`role`) REFERENCES `inforoom2_roles` (`Id`),
	CONSTRAINT `FK98962F1734E2BA77` FOREIGN KEY (`user`) REFERENCES `inforoom2_employee` (`Id`),
	CONSTRAINT `FK98962F17C306973B` FOREIGN KEY (`permission`) REFERENCES `inforoom2_permissions` (`Id`)
)
COLLATE='cp1251_general_ci'
ENGINE=InnoDB;
...
CREATE TABLE internet.`inforoom2_perm_role` (
	...
	INDEX `role` (`role`),
	INDEX `permission` (`permission`),
	CONSTRAINT `FK6EE9C7DB2F2E5505` FOREIGN KEY (`role`) REFERENCES `inforoom2_roles` (`Id`),
	CONSTRAINT `FK6EE9C7DBC306973B` FOREIGN KEY (`permission`) REFERENCES `inforoom2_permissions` (`Id`)
)
COLLATE='cp1251_general_ci'
ENGINE=InnoDB;
